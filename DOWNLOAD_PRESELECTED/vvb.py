...
STARTING_YEAR = 1866    # first year of the newspaper we want to download
ENDING_YEAR = 1952      # last year of the newspaper we want to download
NEWSPAPER_TAG = "vvb"   # ANNO tag of the newspaper we want to download
