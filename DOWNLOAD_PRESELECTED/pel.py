...
STARTING_YEAR = 1876    # first year of the newspaper we want to download
ENDING_YEAR = 1926      # last year of the newspaper we want to download
NEWSPAPER_TAG = "pel"   # ANNO tag of the newspaper we want to download
output_path = f'C:/Users/venglaro/Desktop/preselected_pages/{NEWSPAPER_TAG}'   # path where the images should be stored
no_issue_years = list(range(1878, 1888)) + list(range(1889, 1891))
