...
ENDING_YEAR = 1937      # last year of the newspaper we want to download
NEWSPAPER_TAG = "aze"   # ANNO tag of the newspaper we want to download
...
for year in range(STARTING_YEAR, ENDING_YEAR+1):
    ...
    for url in tqdm.tqdm(days_urls):
        ...
        if year == 1893:
            ...
            target_pages = pages_urls[-3:-2]
            target_pages.extend[-1:]
        elif year >= 1900:
            if DAY in WEEKEND:
                target_pages = pages_urls[-2:]
            else: 
