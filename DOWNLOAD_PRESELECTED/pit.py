...
STARTING_YEAR = 1900    # first year of the newspaper we want to download
ENDING_YEAR = 1938      # last year of the newspaper we want to download
NEWSPAPER_TAG = "pit"   # ANNO tag of the newspaper we want to download
